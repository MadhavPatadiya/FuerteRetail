...
class CustomAppBarMenuOwner {
  CustomAppBarMenuOwner(BuildContext context);
  ...
  static Widget buildMenu(
    ...
    return PopupMenuButton<String>(
      ...
      onSelected: (value) {
        ...
        if (value == 'Final Reports') {
          print(value);
          // Navigate to the RecentPage
          // Navigator.push(
          //   context,
          //   MaterialPageRoute(
          //     builder: (context) => const BankReco(),
          //   ),
          // );
        } else {
          print(value);
  ...
  static buildSubMenu2(
    ...
    return PopupMenuButton<String>(
      ...
      onSelected: (selectedValue) {
        ...
        } else if (label == 'Company Parameter setup' &&
            selectedValue == 'ShortHand Keys') {
          // Navigator.push(
          //   context,
          //   MaterialPageRoute(
          //     builder: (context) => const TaxMaster(),
          //   ),
          // );
