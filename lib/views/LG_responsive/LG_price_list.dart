...
class LedgerPriceList extends StatefulWidget {
  const LedgerPriceList({super.key});

  @override
  State<LedgerPriceList> createState() => _LedgerGroupState();
}

class _LedgerGroupState extends State<LedgerPriceList> {
  ...
  void createGroup() {
    final String priceLsitName = _controller.text;
    if (priceLsitName.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter price category'),
        ),
      );
      return;
    } else {
      final PriceCategory ledgerPriceLsit = PriceCategory(
        id: '',
        companyCode: companyCode!,
        priceCategoryType: priceLsitName,
      );
      PriceCategoryRepository().addPriceCategory(ledgerPriceLsit);
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Pice Category added successfully'),
        ),
      );
